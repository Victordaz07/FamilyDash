        ...
        ListEmptyComponent={() => (
          <View style={styles.emptyState}>
            <View style={styles.emptyIconContainer}>
              <Ionicons name="location-outline" size={80} color="#8B5CF6" />
              <View style={styles.emptyIconGlow} />
            </View>
            <Text style={styles.emptyTitle}>
              {selectedCategory === 'all' 
                ? '¡Explora el mundo juntos! 🌍'
                : `¡Descubre ${getCategoryInfo(selectedCategory).label.toLowerCase()}!`
              }
            </Text>
            <Text style={styles.emptySubtitle}>
              {selectedCategory === 'all' 
                ? 'Agrega lugares especiales para que tu familia siempre sepa dónde encontrarte'
                : `Agrega ubicaciones de ${getCategoryInfo(selectedCategory).label.toLowerCase()} para facilitar la organización familiar`
              }
            </Text>
            <TouchableOpacity

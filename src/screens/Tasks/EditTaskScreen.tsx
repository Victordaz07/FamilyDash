/**
 * EditTaskScreen - Edit existing text-based task
 */
...
import { updateTask, Task } from '../../services/tasks';
            ...
            >
                <View style={styles.headerContent}>
                    ...
                    <View style={styles.headerTextContainer}>
                        <Text style={[styles.headerTitle, { color: colors.textInverse }]}>Edit Task</Text>
                        ...
                        <View style={styles.previewContent}>
                            <View style={styles.previewHeader}>
                                ...
                                <View style={[
                                    ...
                                    <Text style={[styles.previewStatusText, { fontSize: fonts.caption }]}>

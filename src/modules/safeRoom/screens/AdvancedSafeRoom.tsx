...
const mockMessages: SafeRoomMessage[] = [
    {
        id: 'msg_001',
        type: 'audio',
        content: 'sample_audio.mp3',
        metadata: {
            duration: 125,
            size: 1024000,
            format: 'mp3',
        ...
        authorId: 'maria_001',
        authorName: 'Maria Ruiz',
        authorAvatar: '👩',
        createdAt: new Date(Date.now() - 3600000),
        reactions: [
            { id: 'react_001', authorId: 'carlos_001', authorName: 'Carlos', type: 'heart', createdAt: new Date() },
        ],
        comments: [],
        isPublic: true,
    },
    ...
    },
    {
        id: 'msg_003',
        type: 'text',
        content: 'Hey family! I\'m so grateful for all the love and support you give me every day. Thank you for making our home such a wonderful place to be! 💜',
        metadata: {
            wordCount: 35,
            language: 'en',
            sentiment: 'positive',
        ...
        authorId: 'diego_001',
        authorName: 'Diego Alejandro',
        authorAvatar: '👦',
        createdAt: new Date(Date.now() - 10800000),
        reactions: [
            { id: 'react_002', authorId: 'maria_001', authorName: 'Maria', type: 'love', createdAt: new Date() },
            { id: 'react_003', authorId: 'carlos_001', authorName: 'Carlos', type: 'hug', createdAt: new Date() },
        ],
        comments: [
            {
                id: 'comment_001',
                ...
                authorName: 'Maria Ruiz',
                authorAvatar: '👩',
                content: 'We love you too, sweetie! You make us proud every day! 🌟',
                createdAt: new Date(),
                reactions: [],
            },
        ],
